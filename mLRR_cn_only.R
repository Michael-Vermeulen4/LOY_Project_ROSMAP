...
write.table(file="/zfs3/scratch/saram_lab/ROSMAP_CEL/ROSMAP_Cel/gw6/apt/DEC6_apt/mLRR_CN_ONLY_JAN9.txt", x = output, quote=FALSE, row.names=TRUE, sep="\t")
