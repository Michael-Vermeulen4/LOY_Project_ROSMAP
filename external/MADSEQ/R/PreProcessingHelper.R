...
correctGCBias = function(
    ...
    if(plot == TRUE){
            pdf("~/LOY_projct/GCvRAW_plots.pdf")
    ...
    if (plot == TRUE){
        pdf("~/LOY_projct/GCvRAW_after_plots.pdf")
...
calculateNormedCoverage = function(
    ...
    if (plot == TRUE){
        ...
        nChr = ncol(after_chr)
        ## 1. plot raw coverage
        pdf("~/LOY_projct/raw_coverage_plots.pdf")
        ...
        if(nSample>1){
            ...
            pdf("~/LOY_projct/quantiled_cov_plots.pdf")
        ...
        pdf("~/LOY_projct/normed_coverage_plots.pdf")
        plot(1:nChr,rep(1,nChr),type="n",xaxt="n",
...
isHetero = function(x){
    genotype = geno(x)$GT
    genotype == "0|1" | genotype == "1|0" | genotype == "1/0" | genotype == "0/1"
}
